...
\begin{figure}[th]
	...
	\captionsetup{width=\linewidth}
		\begin{subfigure}[b]{0.24\linewidth}
		\includegraphics[width=\linewidth]{./Figures/svd-synthetic/no-noise/fancy_eval_22_point_cloud_no_noise.png}
		\caption{Vertex}
	\end{subfigure}
	\begin{subfigure}[b]{0.24\linewidth}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.24\linewidth}
		\includegraphics[width=\linewidth]{./Figures/gcnn_synthetic/fancy_eval_7_error_GCNN-GCNN_9.47.png}
		\caption{GCNN}
	\end{subfigure}
	\begin{subfigure}[b]{0.24\linewidth}
...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\decoRule
	\caption{Some of detail feature maps of CNN, NOC, GCNN models in up-sampling part on resolution $ 32\times32 $}
...
\begin{figure}
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.18\linewidth}
		\includegraphics[width=\linewidth]{./Figures/gcnn_synthetic/fancy_eval_7_error_f4_err_6.png}
		\caption{F4}
	\end{subfigure}
		\begin{tikzpicture}
		\node[text width=0.1\textwidth] at (11,-1) {90};
