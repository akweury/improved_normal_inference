...
\subsection{Evaluation}
The goal of normal inference is to generate a normal map which each pixel corresponding the normal of input depth map/image. Figure \ref{fig:gcnn-eval-synthetic} is the evaluation of dragon object using trained GCNN model.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_point_cloud_noise.png}
	\includegraphics[width=\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_groundtruth.png}
	\includegraphics[width=\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_normal_GCNN3-32-512.png}	
	\includegraphics[width=\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_error_GCNN3-32-512.png}
