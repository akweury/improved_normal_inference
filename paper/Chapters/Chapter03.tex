...
where $ \oplus $ denotes the element-wise product. This decomposition of the image is based on the intrinsic image model, which was proposed by  \cite{intrinsic-image}. It interprets the observed image into a reflectance image and the shading image. As shown in Figure \ref{fig:intrinsic-image}
...
\subsection{Gated Convolution Neural Network (GCNN) Architecture}
