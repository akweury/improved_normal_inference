...
\subsection{Evaluation}
The goal of normal inference is to generate a normal map which each pixel corresponding the normal of input depth map/image. Figure \ref{fig:gcnn-eval-synthetic} is the evaluation of the dragon object using trained GCNN model. Overall the predicted map is similar to the ground truth.


\begin{figure}[th]
	\centering
	\includegraphics[width=0.2\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_point_cloud_noise.png}
	\includegraphics[width=0.2\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_groundtruth.png}
	\includegraphics[width=0.2\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_normal_GCNN3-32-512.png}
	\includegraphics[width=0.2\linewidth]{./Figures/gcnn-synthetic/fancy_eval_2_error_GCNN3-32-512.png}
	\caption{GCNN Normal Inference on Synthetic Dataset (object: dragon) From left to right: Input vertex map, ground-truth, GCNN normal map, error map.}
