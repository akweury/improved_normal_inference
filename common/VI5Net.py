...
class VINormal(nn.Module):
    def __init__(self, in_ch, out_ch, channel_num, img_num):
        super().__init__()
        ...
        self.i_dconv1 = GConv(img_num, channel_size_1, kernel_down, stride, padding_down)
