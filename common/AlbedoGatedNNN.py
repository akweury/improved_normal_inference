...
class GNet(nn.Module):
    def __init__(self, in_ch, out_ch, channel_num):
        ...
        self.v_dconv3 = GConv(channel_size_1, channel_size_1, kernel_down, stride, padding_down)
        self.v_dconv4 = GConv(channel_size_1, channel_size_1, kernel_down, stride_2, padding_down)
        ...
        self.v_conv2 = nn.Conv2d(channel_size_1, out_ch, (1, 1), (1, 1), (0, 0))
        self.v_conv3 = nn.Conv2d(out_ch, out_ch, (1, 1), (1, 1), (0, 0))

    def forward(self, vertex, light, img):
        v1 = self.v_dconv1(vertex)
        v1 = self.v_dconv2(v1)
        v1 = self.v_dconv3(v1)
        ...
        x3 = self.v_uconv1_1(x3_cat)
        v3 = self.v_uconv1_2(torch.cat((x3, v3), 1))
        ...
        x2 = self.v_uconv2_1(x2_cat)
        v2 = self.v_uconv2_2(torch.cat((x2, v2), 1))
