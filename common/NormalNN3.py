...
class NormalNN3(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        self.__name__ = 'NormalNN3'
        kernel_down = (3, 3)
        kernel_up = (3, 3)
        padding_down = (1, 1)
        padding_up = (1, 1)
    ...
    def forward(self, x0):
        ...
        x3_ds = self.active(self.dconv5(x2_dss))  # 128,128
        # x3_ds = self.active(self.dconv6(x3_ds))  # 128,128
        ...
        xout = self.active(self.uconv5(torch.cat((x23, x1), 1)))  # 512, 512
