...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.albedoInpainting = GConv(1, 1, (3, 3), (1, 1), (1, 1))
        self.lsInpainting = GConv(3, 3, (3, 3), (1, 1), (1, 1))
    ...
    def forward(self, xin):
        ...
        L = self.active(self.lsInpainting(L))

        # rho inpainting
        rho = x_img0 / (torch.sum(x_normal_out * L, dim=1, keepdim=True) + 1e-20)
        x_rho_out = self.active(self.albedoInpainting(rho))
