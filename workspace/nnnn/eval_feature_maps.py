...
gt_resized = mu.image_resize(gt, 512, 512)
mask = gt.sum(axis=2) == 0
mask_512 = gt_resized.sum(axis=2) == 0
...
CV_COLOR = cv.COLORMAP_DEEPGREEN
...
for model_idx, (name, model) in enumerate(models.items()):
    ...
    feature_map_list = convert(feature_map_uconv1, [16, 16, 16, 16, 16, 16, 16, 16])
    # feature_map_list = convert(feature_map_dconv4, [16, 16, 16, 16, 16, 16, 16, 16])
